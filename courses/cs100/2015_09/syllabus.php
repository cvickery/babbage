  ...
  <body>
      ...
      <div>
        ...
        <p>
          ...
          on the job besides you. Instead, you have to manage your time yourself, and you have exams
          and assignments that assess how you are performing in the course.
        </p>
        <p>
        ...
        <p>
          ...
          construct “intelligent agents” from search engines to robots that are able to solve
          complex problems.
        </p>
        <p>
        ...
        <h2>Fall 2015 Special Project</h2>
        <p>
          This semester we are going to take part in a novel experiment. A faculty member in the
          Drama, Theater, and Dance Department has asked us to help design “responsive” costumes
          that will be used in a student dance production. Normally, the course starts with a bit
          of background material to prepare everyone for the coding parts of the syllabus. But
          this term we’ll turn it around and start working with Arduino code and wearable
          electronics right away so we can make real contributions to the costumes. We will all
          be learning a lot this term!
        </p>
        ...
        <p>
          ...
          scientists. (Our class is 67% female this semester.) We will spend some of our class
        ...
        <p>
          ...
          course grade. “Good” grades can offset missing or “not ok” grades.
        </p>
        <p>
          There will be homework and laboratory assignments, with midterm and final exams to assess
          your knowledge of the material covered in the course. In addition, you will work as a team
          to design and build your own Arduino project for the term. You may work either alone or in
          a group of 2-3 on your final project.
        </p>
        <p>
          For the Fall 2015, everyone will work in pairs because of the nature of the dance project
          mentioned above.
        </p>
        <p>
