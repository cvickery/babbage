  ...
  <body>
      ...
      <div>
        ...
        <p>
          ...
          requirement under the CUNY “Pathways” General Education structure. The course could
        ...
        <p>
          ...
          problems: the foundation of goal searching in AI. A second goal is for you to learn how
          computers use binary numbers to encode information: the foundation of the knowledge
        ...
        <p>
          ...
          physical world. The electronic devices  you will be using and the programming language you
          will be learning are called <em>Arduinos</em> and <em>Arduino</em> respectively.
        </p>
        <p>
          ...
          analytically and critically: the hallmarks of human intelligence—the hallmarks of a
        ...
        <p>
          This class meets Tuesdays and Thursdays from 12:15 to 1:30 in Science Building
          Room B-141. If planned renovation proceeds according to schedule during the summer,
          we will be meeting in our work space in SB Room A-205, described below, instead.
        </p>
        <p>
          ...
          will be graded on a 3-point scale: “not ok” (1 point); “ok” (2 points); “good” (3 points).
          ...
          “Good” grades can offset missing or “not ok” grades.
        </p>
        <p>
        ...
        <p>
          ...
          Some assignments will require you to respond to written or video material related to
          ...
          your last project for the course.
        </p>
        ...
        <h2>TIDES Project and Your FYI Learning Community</h2>
        <p>
        ...
        <p>
          Everyone in this class is also taking the same section of ENGL 110, taught by Prof.
          Seufert as part of a Freshman Year Initiative “learning community.” As part of the TIDES
          project, we’ve restricted enrollment in this community to mostly women this term. It’s an
          experiment to see whether we can create an enviroment that is more inclusive than the
          traditional introduction to computer science course, which can seem to put “guys who
          already code” at an advantage. If you <em>are</em> already a coder you <em>will</em> be
          over-prepared for this course, so be prepared to help others in the course with their
          assignments if you finish your own early.
        </p>
