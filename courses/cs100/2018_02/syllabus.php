  ...
  <body>
      ...
      <div>
        ...
        <p>
          ...
          courses. You do not need a Google account to access the course material.
        </p>
        <p>
        ...
        <p>
          ...
          <a href='https://drive.google.com/open?id=1lzLsHVppK1mM1wWgr4ag3ljqmYqj5HCv'>
          the course website on Google Drive</a>. There are folders there where you will find
          assignment descriptions, rough class notes, and copies of daily quizzes (with answers).
        </p>
        <ul>
          <li>Assignment due dates will be posted on the course schedule.</li>
          <li>
            The rough class notes are <em>not</em> a substitute for your own class notes. They
          ...
          <li>
            ...
            answers. The midterm and final exams are based in large part on the daily quizzes.
          </li>
        </ul>
...
<!--         <p>
          ...
          by Mr. Scott Kapuscinski. The big advantage of being part of an FYI community is that it
 ...
 -->
        ...
        <p>
          ...
          which you summarize your experience in that class. <br/>The quizzes and takeaways are
        ...
        <p>
          ...
          Homework will consist of a mix of writing and coding exercises.
        ...
        <ul>
          ...
          <li>
            Coding exercises require a device called a “Circuit Playground.” The lab/classroom is
            set up with these devices and the software you need to work with them. You can also
            install the software on your own computer (it’s free), and you can purchase your own
            Circuit Playground if you wish for about $25. <em>Even if you do your coding exercises
            on your own computer, you have to transfer each assignment to your account in the lab
            so that I can access it for grading. You can <strong>not</strong> submit code by
            email.</em>
          </li>
        </ul>
        ...
        <p>
          ...
          I will announce any such changes, and will update this list accordingly.
