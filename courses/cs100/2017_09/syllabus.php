  ...
  <body>
      ...
      <div>
        ...
        <p>
          ...
          environment used in CSCI-111, students who have completed a C++ course equivalent to
          CSCI-111 are allowed to take this course despite the overlap. But students with more
          programming experience are not allowed to take it. Those students are encouraged to learn
          Arduino on their own!
        </p>
        ...
        <p>
          ...
          <a href='https://drive.google.com/drive/folders/0B28CAPM6eyUPaW13VXVmaDlYTkE'>
        ...
        <ul>
          ...
          <li>
            ...
            answers. The midterm and final exams are based in part on the daily quizzes.
          </li>
        </ul>
        ...
        <p>
          Class meetings begin with a brief quiz based on the reading, lecture, and/or
          video assignments being covered at the time. Classes end with a brief “takeaway”
          exercise in which you summarize your experience in that class.
          <br/>These quizzes and takeaways are graded on a 3-point scale:
        </p>
        <ul>
        ...
        <p>
          If you don’t take a quiz or submit a takeaway, you get 0 points for it. Fifteen per cent of
        ...
        <p>
          ...
          assignments anywhere, but the code has to be written and tested either in the lab or
          online at <a href='https://create.arduino.cc/'>create.arduino.cc</a>. If your code is in
          the lab, you don't have to do anything to submit it; I will simply get a copy from your
          account and test it after the due date. If you use the online system, you will have to
          share the project with me in order for me to grade it. I do not accept code submitted by
          email.
        </p>
