...
<html <?php echo $html_attributes;?>>
  <head>
    ...
    <style>
      ...
      .white-box {border: 1px solid #ccc; width:90%; margin:auto; border-radius:0.5em;}
    </style>
  </head>
  <body>
      <h1>CSCI 100: Information and Intelligence</h1>
      <h2>Fall 2018 Syllabus
      </h2>
      <div>
        ...
        <p>
          ...
          develop “critical thinking” abilities while you are here. At the same time, there is
        ...
        <p>
          ...
          the programming language you will be using is called <em>Arduino</em>. The particular type
          of Arduino device you will be using is called the Adafruit <em><a
          href="https://www.adafruit.com/product/3333">Circuit Playground Express</a></em>,
          which we will generally refer to as a “CPX.” You will be provided with a CPX to use in the
          course at no cost.
        </p>
        <p>
        ...
        <p>
          ...
          give you a good foundation in how computers represent information and work with it. “Big
          Data” and “Data Science” are two important areas of interest that have a lot of overlap
          between computer science and the social sciences. Learning to write code and to work with
          digital information is an important basic skill for work in these areas.
        </p>
        ...
        <p>
          ...
          one. What this course will do is to provide you with a broader sense of the
        ...
        <p>
          ...
          are the same.) Because of the overlap, students who have completed CSCI-111 are not
          eligible to take this course.
        </p>

        <h2>Assignments, Class Notes, and Daily Quizzes</h2>
        <p>
        ...
        <p>
          ...
          moving more and more of my course material to that platform. The course website on babbage
          has three links to Google Drive folders containing assignment descriptions, copies of
          daily quizzes (with answers), and the notes I use for each class.
        </p>
        <ul>
          <li>Assignment due dates will be posted on the course schedule.</li>
          <li>
            The class notes I provide are <em>not</em> a substitute for your own class notes. They
            indicate what I plan to cover in class, but do not include everything I actually cover.
            Taking your own good notes in class and reviewing/editing them afterwards is a critical
            component of the learning process for all courses, including this one.
          </li>
          <li>
            If you miss one of the daily quizzes, the online archive will give you access to the
            answers.
          </li>
        </ul>
        ...
        <p>
          This section of CSCI 100 is part of a “Freshman Year Initiative” (FYI) learning community.
          That means that all 20 of you are registered for the same section of English 110, taught
          by Prof. Katy Harding. The big advantage of being part of an FYI community is that it
          gives you a chance to get to know, and to work with, a small group of fellow freshmen as
          you navigate your first semester at Queens College.
        </p>
        ...
        <div class="white-box">
          <aside>
            ...
            <ul>
              ...
              <li>If you have to miss a class for some reason and you let me know what the reason is
                ahead time, I will excuse you from the quiz for that class. There is a limit on how
                many times you can be excused from a quiz. There is no way to be excused from a
                takeaway.</li>
            </ul>
          </aside>
          <p>
            ...
            which you summarize your experience in that class. <br/>The quizzes, takeaways, and most
          ...
          <p>
            ...
            If you don’t take a quiz or submit a takeaway, you get 0 points for it. Fifteen per cent
            of your course grade will be based on your quiz and takeaway scores, which will be
            computed as follows: your quiz score will be your total number of quiz points divided by 2
            times the number of quizzes; likewise for your takeaway score. At the end of the term you
            will have a quiz score and a takeaway score, which are your total quiz/takeaway points
            divided by 2 times the number of quizzes/takeaways.
        ...
        <p>
          But you will also be using the lab outside of class times to do your coding assignments.
          The lab will be available any time the Computer Science Department Office is open,
          including evening hours. You will be learning to work with electronic circuits called
          ...
          in small lockers in the room. You and a partner from the course will be given the
          combination to one of the lockers, where you can keep your lab materials to use outside of
          class time.
        </p>
        <p>
          ...
          the lab to test your code before you submit it, and (b) <strong>you will have to leave the
          code for your assignments in your lab account in order to receive credit for
          them.</strong>
        </p>
        <p>
        ...
        <p>
          There is another section of CSCI 100 that uses the lab this semester, so the room will not
          be available when that section is meeting (Wednesdays from 4 to 7 pm).
        </p>
        <p>
          Homework assignments will consist of a mix of writing and coding exercises. They can be
          submitted up to one week late for partial credit.
        </p>
        <ul>
          <li>
            Submit written assignments by sharing a G-Suite document with me. Be sure to give me
            permission to add comments to your document. To access your QC G-Suite account, go to
            <a href="https://drive.google.com">https://drive.google.com</a> and sign in using your
            QC email address. If you have a personal Gmail account you can do the work there
            instead, but I prefer to have you use your QC account.
          </li>
          <li>
            Coding exercises use a device called a “Circuit Playground Express” (CPX). The
            lab/classroom is set up with these devices and the software you need to work with them.
            You can also install the software on your own computer (it’s free), and you can purchase
            your own Circuit Playground if you wish for about $25. <em>Even if you do your coding
            exercises on your own computer, you have to transfer each assignment to your account in
            the lab so that I can access it for grading. You can <strong>not</strong> submit code by
            email.</em>
          </li>
        </ul>
        ...
        <p>
          ...
          time as a full-time job, so if you take five 3-credit courses, each one requires a 9-hour
          time commitment per week. (5 courses times 9 hours = 45 hours per week.) The difference
        ...
        <p>
          ...
          Each topic will be addressed in overlapping segments of the class meetings. That is, we
          won’t spend <em>X</em> weeks on one topic, then <em>Y</em> weeks on the next one. Rather,
          we will be revisiting different parts of each topic throughout the course. The percentages
          show the approximate amount of course time that will be devoted to each topic.
        ...
        <p>
          The midterm and final exams are based on the daily quizzes, assignment write-ups, my class
          notes, and your class notes. The idea is that the quizzes are “low stakes” so you don’t
          to worry too much about each one; the assignments are intended for you to work on with
          others in the class; and the class notes cover the topics of importance without being part
          of your grade for the course. But the notes, assignments, and quizzes are all important in
          preparing you for the exams, which count for over half of your course grade.
        </p>
        <p>
          Each semester is a little different, so the following percentages are subject to revision.
          I will announce any changes in class, and will update this list accordingly.
        </p>
        <ul>
          <li>
            5% Takeaways
    ...
    <div>
      <p>
        ...
        The programming assignments use a small device called a “Circuit Playground,” which will be
        available for you to use in the lab. You can purchase your own for $25. We will place an
        order for everyone interested in that option at the beginning of the term.
