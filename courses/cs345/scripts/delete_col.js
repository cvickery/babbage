...
/*  Allow user to delete columns of the configuration summary table.
 *
 *  C. Vickery
 *  February 2007
 *
 *  2007-03-09: Instead of hiding columns, delete them so they won't
 *  print.  Make the tooltip hide/show instead of highlight/not.
 */

/*  List of class names used in the columns that can be deleted.
 ...
 */
  function doHide(e)
  {
    ...
    if (platform != undefined)
    {
      var headingRow = whichNode.parentNode;
      ...
      headingRow.removeChild(whichNode);
    }
  }
