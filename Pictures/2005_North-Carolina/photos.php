...
echo "XML file is $xmlFile";
    ...
    else if ($isImageList or $isImageListTXT)
    {
      //  Process the simple text file list
      $txtFile = $isImageList ? "image_list" : "isImageListTXT";
echo "text file is $txtFile";
