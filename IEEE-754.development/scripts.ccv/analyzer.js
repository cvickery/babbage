...
//      }
  ...
  $('input').bind('keyup', 'ctrl+q', function(){window.location = $('#faq')[0].getAttribute('href');});
    ...
    function doUpdate()
    {
      ...
      if (value.isValid)
      {
            ...
            || analyzer.value_entered.value.toLowerCase() === 'snan')
        {
          ...
          if (n == 'qNaN')
          {
            analyzer.hex64_fraction_value.nodeValue = '1xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx';
          }
          else
          {
            analyzer.hex64_fraction_value.nodeValue = '01xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx';
          }
          ...
          if (n == 'qNaN')
          {
            analyzer.hex128_fraction_value.nodeValue = '1xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx';
          }
          else
          {
            analyzer.hex128_fraction_value.nodeValue = '01xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx';
          }
    ...
    $("#block" + num)
        .html(
            "<div class='identifier'><p>Analyzer "
                ...
                + num
                + "' title='progress' src='../../IEEE-754.development/scripts.ccv/images/ajax-loader.gif' alt=''/>"
